                ...
                <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                    <button
                        ...
                        @if (Auth::user()->user_detail->photo != NULL)
                            ...
                            src="{{ Storage::url(Auth::user()->user_detail->photo) }}" alt="photo">
                        @else
                ...
                <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                    ...
                    <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                        <div>
                            ...
                            <p class="mt-2 text-2xl font-semibold text-left text-gray-800">{{ $freelancer_work ?? '' }}</p>
                            <p class="text-sm text-left text-gray-500">
                                    ...
                                    <td class="w-1/3 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                 @if (Auth::user()->user_detail->photo != NULL)
                                                    <img class="inline w-10 h-10 mr-3 rounded-full"
                                                    src="{{ Storage::url(Auth::user()->user_detail->photo) }}" alt="photo">
                                                @else
                                            ...
                                            <div>
                                                ...
                                                @if ($order->order_status_id == 1)
                                                    <p class="text-sm text-green-400">{{ $order->order_status->name ?? '' }}</p>
                                                @elseif ($order->order_status_id == 2)
                                                    <p class="text-sm text-yellow-400">{{ $order->order_status->name ?? '' }}</p>
                                                @elseif ($order->order_status_id == 3)
                                                    <p class="text-sm text-red-400">{{ $order->order_status->name ?? '' }}</p>
                                                @else
                                                    <p class="text-sm text-black-400">{{ $order->order_status->name ?? '' }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
