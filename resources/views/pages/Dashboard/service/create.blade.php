                        ...
                        <div class="">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Service apa yang ingin kamu tawarkan?" type="text" name="title" id="title" autocomplete="title" value="{{ old('title') }}"
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" name="description" id="description" autocomplete="description" value="{{ old('description') }}"
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan service.." type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" 
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" 
                                        ...
                                        <button type="button" id="addServicesRow" 
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            ...
                                            <option value="4">5 Revisi</option>
                                            <option value="8">7 Revisi</option>
                                            <option value="16">10 Revisi</option>
                                            <option value="32">12 Revisi</option>
                                        </select>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Total Harga Service Kamu" type="number" name="price" id="price" autocomplete="price" required value="{{ old('price') }}"
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Thumbnail 1" type="file" name="thumbnail[]"
                                            id="thumbnail" autocomplete="thumbnail" required
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan kamu.." type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user"
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                            ...
                            <div class="px-4 py-3 text-right sm:px-6">
                                ...
                                <button type="submit"
                                    ...
                                    onclick="return confirm('Are you sure want to add this service?')">
                                    Create Service
                                </button>
                            </div>
                        </div>
