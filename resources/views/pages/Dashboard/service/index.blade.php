                                            ...
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if (isset($service->service_thumbnail->first()->thumbnail))
                                                            <img class="object-cover w-full h-full rounded"
                                                            src="{{ Storage::url($service->service_thumbnail->first()->thumbnail) }}"
                                                            alt="" loading="lazy" />
                                                        @else
                                                            <img class="object-cover w-full h-full rounded"
                                                            src="{{ asset('assets/images/empty-illustration.svg') }}"
                                                            alt="" loading="lazy" />
                                                        @endif
