                        ...
                        <div class="">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Service apa yang ingin kamu tawarkan?" type="text"
                                            name="title" id="title" autocomplete="title" value="{{ $service->title }}" required
                                    ...
                                    <div class="col-span-6">
                                        <label for="description"
                                            class="block mb-3 font-medium text-gray-700 text-md">Deskripsi Service</label>
                                        <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text"
                                            name="description" id="description" autocomplete="service-name" value="{{ $service->description }}" required
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        <label for="advantage-service"
                                            class="block mb-2 font-medium text-gray-700 text-md">Keunggulan Service kamu</label>
                                        <p class="block mb-3 text-sm text-gray-700">
                                            Hal apa aja yang didapakan dari service kamu?
                                        </p>
                                        @forelse ($service_advantages as $item)
                                            <input placeholder="Keunggulan service.." type="text" name="{{ 'advantage-services['.$item->id.']' }}"
                                                id="advantage-services" autocomplete="advantage-services" value="{{ $item->advantage }}" required
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"> 
                                        @empty
                                    ...
                                    {{-- Delivery Time & Revision Limit Label --}}
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Total Harga Service Kamu" type="number" name="price" id="price" autocomplete="price" required value="{{ $service->price }}"
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        <label for="service-name"
                                            class="block mb-3 font-medium text-gray-700 text-md">Thumbnail Service Feeds</label>
                                                                                
                                            @forelse ($service_thumbnails as $item)
                                                <div class="flex my-4">
                                                    <img src="{{ Storage::url($item->thumbnail) }}" alt="thumbnail"
                                                    class="inline object-cover w-24 rounded flex-auto" for="choose">

                                                    <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$item->id.']' }}"
                                                        id="thumbnails" autocomplete="thumbnails"
                                                        class="block w-full py-3 pl-5 mt-3 ml-4 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">                                                    
                                                </div>  
                                            @empty
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse ($user_advantages as $item)
                                            <input placeholder="Keunggulan kamu.." type="text" name="{{ 'advantage-users['.$item->id.']' }}" id="advantage-users" autocomplete="advantage-users"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                value="{{ $item->advantage }}" required>
                                        @empty
                                        ...
                                        <button type="button" id="addAdvantagesRow"
                                        class="inline-flex justify-center px-3 py-2 mt-3 text-xs font-medium text-gray-700 bg-gray-100 border border-transparent rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">                                           
                                            Tambahkan Keunggulan +
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $service->note ?? ''}}">
                                    ...
                                    {{-- Tagline --}}
                                    <div class="col-span-6">
                                        <label for="taglines" class="block mb-3 font-medium text-gray-700 text-md">
                                            Tagline 
                                                <span class="text-gray-400">(Optional)</span>
                                        </label>

                                        @forelse ($taglines as $item)
                                            <input placeholder="Tagline.." type="text" name="{{ 'taglines['.$item->id.']' }}" id="taglines" autocomplete="taglines" required
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $item->tagline }}">
                                        @empty
                                        ...
                                        <button type="button" id="addTaglineRow" 
                                        class="inline-flex justify-center px-3 py-2 mt-3 text-xs font-medium text-gray-700 bg-gray-100 border border-transparent rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                            Tambahkan Tagline +
                                        </button>
                                    </div>
                            ...
                            <div class="px-4 py-3 text-right sm:px-6">
                                ...
                                <button type="submit"
                                    ...
                                    onclick="return confirm('Are you sure want to update this service?')">
                                    Save Changes
                                </button>
                            </div>
                        </div>
...
@push('after-script')
    <script
        src="{{ url('https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js') }}">
    </script>
