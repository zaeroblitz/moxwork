                                    ...
                                    <tr class="text-gray-700 border-b">
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($order->user_buyer->user_detail->photo != NULL)
                                                        <img class="object-cover w-full h-full rounded-full"
                                                        src="{{ Storage::url($order->user_buyer->user_detail->photo) }}" alt="photo"
                                                        loading="lazy" />    
                                                    @else
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-400">{{ $order->user_buyer->user_detail->role ?? '' }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                             @if ($order->order_status_id == 1)
                                                ...
                                                <p class="px-4 py-2 mt-2 inline text-center text-green-500">
                                                    Approved
                                                </p>
                                            ...
                                            @elseif ($order->order_status_id == 3)
                                                ...
                                                <p class="px-4 py-2 mt-2 inline text-center text-red-500">
                                                    Rejected
                                                </p>
                                            @else
                                                <a href="{{ route('member.order.accept', $order->id) }}"
                                                    class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-button">
                                                    Accept
                                                </a>
                                                <a href="{{ route('member.order.reject', $order->id) }}" 
                                                    class="px-4 py-2 mt-2 text-center text-black rounded-xl">
                                                    Reject
                                                </a>
                                            @endif                                            
                                        </td>
...
@else
    <div class="flex h-screen">
        <div class="m-auto text-center">
            <img src="{{ asset('assets/images/empty-illustration.svg') }}" alt=""
                class="w-48 mx-auto">
            <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
