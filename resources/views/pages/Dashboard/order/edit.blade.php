                                    ...
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                            @if ($order->user_freelancer->user_detail->photo != NULL)
                                                ...
                                                src="{{ Storage::url($order->user_buyer->user_detail->photo) }}" alt=""
                                                loading="lazy" />
                                            @else
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">{{ $order->user_buyer->user_detail->contact_number ?? '' }}</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <div class="m-auto text-center">
                                ...
                                <div class="relative mt-0 md:mt-6">
                                    ...
                                    @else
                                        ...
                                        <label class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr" for="choose">
                                            Choose File                                         
                                        </label>
                                    @endif                                    
                                </div>
                                ...
                                @if ($errors->has('file'))
                                    <p class="text-danger-500 text-sm mt-4">{{ $errors()->first('file') }}</p>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="p-1 mt-5">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <textarea placeholder="Enter your note here.." type="text"
                                    ...
                                    @if ($errors->has('note'))
                                        <p class="text-danger-500 text-sm mt-4">{{ $errors->first('note') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="px-1 py-4 text-right">
                                <a type="button" href="{{ route('member.order.index') }}"
